...
**Information Expert Decision Support System** (infoX DSS) is an ongoing project for AI development carried out since 2020, after the completion of the first phase in 2019, when the prototype, infoX Pro, was programmed, registered for copyright protection, and certified by the Dept. of Intellectual Property on May 23, 2019 (Registration Number v1.8027). The new AI, InfoX DSS, comes with UI improvement and can give more diverse opinions on official information disclosure under the Official Information Act, B. E. 2540. The AI will use all the key facts provided by the user and make decsions with the decision trees trained through suppervised learning. It works in three steps: Checking the person's right, checking the information existance and properties, and checking the legal articles that allow the officer to close (or mainly disclose) the type of governmental information being requested.
