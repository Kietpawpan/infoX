...
**Information Expert Decision Supporting System** (infoX DSS) is an ongoing AI development project carried out since 2020, after the completion of the first phase in 2019 that results in the prototype called infoX Pro, registered for copyright protection on May 13, 2019, reg. no. v1.8027, certified by the Department of Intellectual Property on May 23, 2019). InfoX can give expert opinions on official information disclosure under the Official Information Act, B. E. 2540, based on the facts the user provide and the decision trees trained through suppervised learning. The AI works step-by-step, from checking the person's right, checking the information existance and properties, to checking the relevant legal articles that allow the officer to disclose or close the governmental information being requested.
