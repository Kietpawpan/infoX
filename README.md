...
**Information Expert Decision Support System** (infoX DSS) is an ongoing project for AI development carried out since 2020, after the completion of the first phase in 2019 that results in the prototype AI called infoX Pro, registered for copyright protection on May 13, 2019, reg. no. v1.8027, certified by the Department of Intellectual Property on May 23, 2019). InfoX DSS can give expert opinions on official information disclosure under the Official Information Act, B. E. 2540, based on the facts the user provide and the decision trees trained through suppervised learning. The AI works in three steps: Checking the person's right, checking the information existance and properties, and checking the legal articles that allow the officer to close (or mainly disclose) the type of governmental information being requested.
