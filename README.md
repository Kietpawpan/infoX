...
2. Move the downloaded file (**infoX-1.4.1.zip**) to the **Desktop** of your computer.
3. Double click the **infoX-1.4.1.zip** file and extract **InfoXInstaller.cmd** to the Desktop.
