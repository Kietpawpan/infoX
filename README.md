...
**Information Expert Decision Support System** (infoX DSS) is an ongoing project for AI development carried out since 2020, after the completion of the first phase in 2019, when the prototype, infoX Pro, was programmed, registered for copyright protection, and certified by the Dept. of Intellectual Property on May 23, 2019 (Registration Number v1.8027). The new AI, InfoX DSS, comes with UI improvement and can give more diverse opinions on official information disclosure under the Official Information Act, B. E. 2540. To give expert opinions, the AI needs to know all the key facts from the user. Then, it makes decsions with the decision trees that have been trained through suppervised learning. It always works in three steps: (i) checking the person's right, (ii) checking the information existance and property, and (iii) refering to the legal article (or articles) that allow the the close (or mainly the disclose) of the governmental information being requested.
